...
```bash
clickup-automation$ sam build --use-container
```
...
```bash
clickup-automation$ sam local start-api
clickup-automation$ curl http://localhost:3000/
```
...
```bash
clickup-automation$ pip install -r tests/requirements.txt --user
# unit test
...
```bash
aws cloudformation delete-stack --stack-name clickup-automation
```
